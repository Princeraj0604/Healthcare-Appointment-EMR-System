      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">Stay updated on your appointment status and medical records.</p>
          </div>
        ...
        {isLoading ? (
          ...
          <Card className="p-12 text-center rounded-2xl bg-white border-slate-200">
            ...
            <p className="text-xs text-slate-400 mt-1">You are all caught up with your updates.</p>
          </Card>
        ) : (
          <div className="space-y-3">
